from jasm.global_definitions import IGNORE_INST_ADDR, OPTIONAL_COMMA, OPTIONAL_PERCENTAGE_CHAR, RegisterCaptureSuffixs
from jasm.regex.tree_generators.capture_group import CaptureGroupIndexInstruction, CaptureGroupIndexRegister
