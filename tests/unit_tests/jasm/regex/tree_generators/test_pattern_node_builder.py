...
def test_pattern_node_builder_no_parents_with_dict(mock_shared_context: SharedContext) -> None:
...
def test_get_times(input_times: dict[str, int], expected: TimesType, mock_shared_context: SharedContext) -> None:
